...
<img style="float:center; padding-left:10px; padding-bottom:10px;padding-top:10px" src="/images/flexdash_example.png"" alt = "MOSAIC dashboard screencap"">
...
<img style="float:right; padding-left:10px; padding-bottom:10px;padding-top:10px;width:200px;height:31px" src="/images/flexdash_valuebox.png"" alt = "valueBox example"">
...
Building this dashboard has been (and continues to be!) an iterative process, based on the needs of our various teams. **It is meant to facilitate communication, not to replace it.**  No matter how snazzy it looks, a dashboard isn't informative at all if the user doesn't have the background and knowledge they need to interpret it, or if it's not giving information that can lead to action. Our immediate goal with this dashboard is to alert us quickly to anything going on that warrants either corrective action or positive reinforcement. This in turn helps us get to our ultimate goal: to produce the strongest research possible, which will advance science and improve the experiences of critically ill patients and their loved ones.
