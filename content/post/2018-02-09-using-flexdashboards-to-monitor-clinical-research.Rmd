...
![*Screencap of MOSAIC dashboard*](flexdash_example.png)
...
<img style="float:right; padding-left:10px; padding-bottom:10px;padding-top:10px;width:200px;height:31px" src="/images/flexdash_gauge.png"" alt = "gauge example"">
