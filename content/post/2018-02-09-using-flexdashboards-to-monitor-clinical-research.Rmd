...
<img style="float:right; padding-left:10px; padding-bottom:5px;padding-top:10px;width:275px;height:95px" src="/images/flexdash_valuebox.png"" alt = "valueBox example"">
...
Building this dashboard has been (and continues to be!) an iterative process, based on the needs of our various teams. **It is meant to facilitate communication, not to replace it.**  No matter how snazzy it looks, a dashboard isn't informative at all if the user doesn't have the background and knowledge they need to interpret it, or if it's not giving information that can lead to action. Our immediate goal with this dashboard is to alert us quickly to important changes or successes, so that we can communicate as a team to implement corrective action or reinforce what's working. The dashboard is a tools to get to our ultimate goal: to produce the strongest research possible, which will advance science and improve the experiences of critically ill patients and their loved ones.
