...
<img style="float:right; padding-left:10px; padding-bottom:10px;padding-top:10px;width:275px;height:95px" src="/images/flexdash_valuebox.png"" alt = "valueBox example"">
