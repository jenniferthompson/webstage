...
Empathy was all over this conference - in attendees' interactions, for example, and in the scope of the program, which made sure to have a place for all levels of R users and people from all sorts of backgrounds. Most obvious was JD Long's great talk on ["The Unreasonable Effectiveness of Empathy"](https://www.youtube.com/watch?v=P7VnKgVMLvY) *(previous version)*, in which he talked about how putting ourselves in someone else's shoes can be helpful in both communicating results and in anticipating the needs of our clients/collaborators/users (thus saving ourselves time and pain). [Kayla Patel](https://paylakatel.github.io/) talked about developing a Shiny dashboard for [Imagine Boston 2030](https://analytics.boston.gov/app/imagine-boston) that keeps the end user in mind first and foremost - for example, prioritizing clarity and accessibility over technical bells and whistles. At the closing fireside chats, [Eduardo Ariño de la Rubia](https://www.linkedin.com/in/earino/) had some important thoughts on the data science hiring process and workers' identity in a changing society.
    
    ```{r echo = FALSE}
    blogdown::shortcode_html('tweet', '959945435216408577')

    ```

I'm stopping here to keep this a reasonable length, but I could go on. It was so evident that the group gathered cares about all facets of users' experiences, from tools to community.

### Cross-pollination

This conference brought people together from all kinds of backgrounds and contexts - just off the top of my head, I met people with backgrounds in marine science and ecology, GIS, energy, tech, and agriculture. Everyone was learning from each other, getting inspiration from each other, and having a great time meeting each other. Only good can come from this.
...
The actual conference was absolutely fantastic, but to be quite honest the best part of the week was reconnecting with friends and meeting new ones. The R world is full of the best, most fun people.
