...
```{r, echo = FALSE}
knitr::include_graphics("/images/biostatlifecycle.png")
```
...
your team get to your goal.

*(In our context, we’ve successfully used our statistical analysis plan to
handle this. We recently had a major clinical trial [published](https://nejm.org/doi/full/10.1056/NEJMoa1808217); particularly in
...
```{r, echo = FALSE}
knitr::include_graphics("/images/focusadhoc.png")
```
...
```{r, echo = FALSE}
knitr::include_graphics("/images/raciexample.png")
```
